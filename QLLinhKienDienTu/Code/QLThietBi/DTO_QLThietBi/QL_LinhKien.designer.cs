...
namespace DTO_QLThietBi
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="QL_THIETBITH")]
    ...
    partial void DeleteTAIKHOANG(TAIKHOANG instance);
		...
		public QL_LinhKienDataContext() : 
				base(global::DTO_QLThietBi.Properties.Settings.Default.QL_THIETBITHConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class NHANVIEN : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<TAIKHOANG> _TAIKHOANGs;
    ...
    partial void OnDIACHIChanged();
		...
		public NHANVIEN()
		{
			...
			this._DONHANGs = new EntitySet<DONHANG>(new Action<DONHANG>(this.attach_DONHANGs), new Action<DONHANG>(this.detach_DONHANGs));
			this._DONNHAPs = new EntitySet<DONNHAP>(new Action<DONNHAP>(this.attach_DONNHAPs), new Action<DONNHAP>(this.detach_DONNHAPs));
			this._TAIKHOANGs = new EntitySet<TAIKHOANG>(new Action<TAIKHOANG>(this.attach_TAIKHOANGs), new Action<TAIKHOANG>(this.detach_TAIKHOANGs));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NHANVIEN_TAIKHOANG", Storage="_TAIKHOANGs", ThisKey="MANV", OtherKey="MANV")]
		public EntitySet<TAIKHOANG> TAIKHOANGs
		{
			get
			{
				return this._TAIKHOANGs;
			}
			set
			{
				this._TAIKHOANGs.Assign(value);
			}
		}
		...
		private void attach_TAIKHOANGs(TAIKHOANG entity)
		{
			this.SendPropertyChanging();
			entity.NHANVIEN = this;
		}
		
		private void detach_TAIKHOANGs(TAIKHOANG entity)
		{
			this.SendPropertyChanging();
			entity.NHANVIEN = null;
		}
    ...
    partial void OnMANVChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TENTK", DbType="NChar(36) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string TENTK
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="NHANVIEN_TAIKHOANG", Storage="_NHANVIEN", ThisKey="MANV", OtherKey="MANV", IsForeignKey=true)]
		public NHANVIEN NHANVIEN
		{
			get
			{
			...
			set
			{
							...
							|| (this._NHANVIEN.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._NHANVIEN.Entity = null;
						previousValue.TAIKHOANGs.Remove(this);
					}
					this._NHANVIEN.Entity = value;
					if ((value != null))
					{
						value.TAIKHOANGs.Add(this);
						this._MANV = value.MANV;
					}
					else
					{
